    ...
    <footer className="bg-black text-white">
      ...
      <div className="mx-auto max-w-[1440px] px-8 py-12 lg:px-0 lg:py-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
          {/* Left Section - Logo, Email, Social */}
          <div className="space-y-8">
            {/* Logo */}
            <div className="flex h-16 w-74 items-center gap-3">
              <Image
                width={320}
                height={64}
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                <input
                  type="checkbox"
                  id="newsletter"
                  className="mt-1 h-4 w-4 rounded border-gray-400 bg-transparent text-blue-500 focus:ring-2 focus:ring-blue-500"
                />
                <label htmlFor="newsletter" className="text-sm leading-relaxed text-gray-400">
          ...
          {/* Right Section - Description and Links */}
          <div className="space-y-8">
            {/* Description */}
      ...
      <div className="bg-blue-500 py-4">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-center text-sm text-white">
            2025 © Trust Delivery All rights reserved.
          </p>
        </div>
      </div>
    </footer>
